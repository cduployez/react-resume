...
function Category(props: CategoryProps): React.JSX.Element {
    let [categoryDisplayed, setCategoryDisplayed]: UseStateType<boolean> = useState(true);
    ...
    return (
        <>
            <CategoryTitle categoryTitle={props.categoryTitle} categoryDisplayed={categoryDisplayed} onCategoryDisplayClick={toggle}/>
